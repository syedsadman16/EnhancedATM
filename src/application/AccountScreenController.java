...
public class AccountScreenController {
    ...
    @FXML
    private Button settingBtn; //goes to settings screen
    
    public void goToSettingsScreen(ActionEvent event) throws IOException {
		Parent nextScene = FXMLLoader.load( getClass().getResource("/application/SettingsScreen.fxml") );
		Scene settings = new Scene(nextScene);
    ...
    public void goToSummaryScreen(ActionEvent event) throws IOException {
		Parent nextScene = FXMLLoader.load( getClass().getResource("/application/AccountSummary.fxml"));
    ...
    void initialize() {
        ...
        assert settingBtn != null : "fx:id=\"settingBtn\" was not injected: check your FXML file 'AccountScreen.fxml'.";
